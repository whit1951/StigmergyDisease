...
```{r}
library(doBy)
merged_data_stig<-size100[which(size100$dir_move==TRUE),]

merged_data_rand<-size100[which(size100$dir_move==FALSE),]
...
tiff("S1Fig.tiff", height =8.75 , width =6.34, units = "in", compression = "lzw", res = 600)
multiplot(gg, hh, cols=1)
dev.off()
```
...
```{r}
library(doBy)
merged_data_stig<-size50[which(size50$dir_move==TRUE),]

merged_data_rand<-size50[which(size50$dir_move==FALSE),]
...
tiff("S2Fig.tiff", height =8.75 , width =6.34, units = "in", compression = "lzw", res = 600)
multiplot(gg, hh, cols=1)
dev.off()
```
## Figure 5
