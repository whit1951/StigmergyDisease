...
tiff("FigS1.tiff", height =22.23 , width =19.05, units = "cm", compression = "lzw", res = 600)
multiplot(gg, hh, cols=1)
dev.off()
```
...
tiff("S2Fig.tiff", height =22.23 , width =13, units = "cm", compression = "lzw", res = 600)
multiplot(gg, hh, cols=1)
dev.off()
```
## S3 Fig 
...
tiff("S3Fig.tiff", height =22.23 , width =13, units = "cm", compression = "lzw", res = 600)
multiplot(gg, hh, cols=1)
dev.off()
```
