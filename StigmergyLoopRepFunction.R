...
#'@param nrep - if splitting nsim into reps, the rep number
...
StigLoopRep<-function(maxT, nsim, nrep, lsize, n.initial, inf_prob, rec_rate, dur_scent, initial_load, scent_decay, inf_decay){
  ...
  filename<-paste("lsize", lsize, "n.initial", n.initial, "inf", inf_prob, "rec", rec_rate,"dur_scent",dur_scent,"initial_load",initial_load, "scent_decay", scent_decay, "inf_decay", inf_decay, "nrep", nrep, sep="")
